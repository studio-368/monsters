...
public final class AspectRatioTool {
    ...
    // While the local variables are technically unnecessary below, they enhance readability by introducing
    // a poetic parallel structure. Suppressing the warning.
