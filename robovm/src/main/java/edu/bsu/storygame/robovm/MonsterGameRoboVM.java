package edu.bsu.storygame.robovm;
...
public class MonsterGameRoboVM extends UIApplicationDelegateAdapter {
  ...
  public static void main (String[] args) {
    ...
    UIApplication.main(args, null, MonsterGameRoboVM.class);
    pool.close();
  }
}
